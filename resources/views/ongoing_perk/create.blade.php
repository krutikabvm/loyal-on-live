...
@section('content')
    ...
    <div class="busines1-main">
        ...
        <div class="business-step1" id="profiles">
            ...
            @endif
            <form action="{{ route('ongoing_perk.store') }}" method="POST" id="limited_perks_form">
                @csrf
                ...
                <div class="col-md-7 ">
                    ...
                    <div class="account-type-main" style="margin-top:25px">
                            <div style="margin-bottom:6px">
                                ...
                                <textarea id="description" name="description" class="form-control" placeholder="Input perk description…"></textarea>
                            </div>
                                ...
                                <div class="col-md-4" style="margin-top:6px">
                                    <div class="">
                                        ...
                                        <select id="week_days" name="week_days[]" class="form-control" multiple>
                                            ...
                                            <option value="Mon" data-day="mon">Mon</option>
                                            <option value="Tue" data-day="tue">Tue</option>
                                            <option value="Wed" data-day="wed">Wed</option>
                                            <option value="Thu" data-day="thu">Thu</option>
                                            <option value="Fri" data-day="fri">Fri</option>
                                            <option value="Sat" data-day="sat">Sat</option>
                                            <option value="Sun" data-day="sun">Sun</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row hidden optional" style="margin-top:10px">
                                <div class="col-md-3" style="margin-top:6px">
                                    <div class="">
                                        ...
                                        <input type="text" class="form-control" name="minimum_spend" id="minimum_spend">
                                    </div>
                                </div>
                                <div class="col-md-3" style="margin-top:6px">
                                    <div class="">
                                        <label for="estimated_savings">Estimated savings</label>
                                        <input type="text" class="form-control" name="estimated_savings" id="estimated_savings">
                        ...
                        <div>
                            ...
                            <div class="perk-ticket" style="padding-bottom:24px">
                                <div class="header">
                                    ...
                                    <span class="timer" style="border:2px solid white;border-radius:20px;padding:6px;font-size:8px"> 4 uses per month</span>
                                </div>
<!-- 
                                <div class="ticketRip">
                                ...
                                <div class="content" style=" margin-top: 40px;margin-left: 12px;margin-right: 12px;">
                                    <h3 style="color:#ffffffb3;text-align:left;font-family:Rammetto One,cursive!important;;font-size:14px;margin-top:8px;margin-bottom:24px" class="title">Perk Description...</h3>
