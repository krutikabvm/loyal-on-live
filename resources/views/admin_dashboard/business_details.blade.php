            ...
            <div class="row">
                ...
                <div class="col-md-6 location-card">
                    @foreach(@$locations as $key => $location)
                        ...
                        <div class="open-table-main open-table-main-new">
                            <div class="open-table-inner">
                                ...
                                @if($key != 0)
                                  @if($location->status)
                                  <span class=" insight-btn-status insight-btn-status-deactive" data-id="{{$location->id}}"> Deactivate</span>
              
                                  @else
                                  <span class=" insight-btn-status insight-btn-status-active" data-id="{{$location->id}}"> Activate</span>
                                  @endif
                                  @endif
                                ...
                                <div class="open-table-main pl-0 pr-0">
    						          <form class="time_table1" id="time_table_{{$key}}" data-form-id="{{$key}}">
                                        <input type="text" id="locup{{$key}}" name="locup" onkeypress="insert_location_option(this,'{{$key}}')" value="{{@$location->address}}" class="form-control locup" style="display: none">
                            ...
                            @if(count($locations) == $key + 1)
                              <a href="#" id="addLocationBtn" class="insight-btn-location"><img src="{{asset('admin_dashboard/assets/images/plus.png')}}" height="21px;" style="margin-top:-3px; margin-right:5px;" alt="no img"> Add Another Location</a>
                            @endif
                        </div>
...
<script>
  ...
  function insert_location_option(input = null,key = null) {
...
autocomplete.addListener("place_changed", () => {
  ...
  geocoder
    ...
    .then(({
     ...
     var parent = document.getElementById("time_table_"+key);
      parent.appendChild(input);
      parent.appendChild(input2);
...
$(document).ready(function() {
  $(document).on('submit', '.time_table1', function(event) {
    event.preventDefault();
    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        //   console.log(result);
        $("#empty"+form_id).css("display", "none");
  ...
  //$(".table_time1").click(function() {
    $(document).ready(function() {
    $(document).on("click",".table_time1",function() {
    var id = $(this).data('id');
    
    $(".open-table-main"+id).show();
  ...
  //     // Clone the HTML structure of the first location
  //     var newLocation = $('.location-card:first').clone();

  //     // Clear input values if needed (optional)
  //     newLocation.find('input[type="text"]').val('');

  //     // Append the cloned structure to the container
  //     $('.location-card:last').after(newLocation);
  //   });
  // });

  //$(document).ready(function () {
   // var locationCount = 1; // Initialize the location count

    // Handle the "Add Another Location" button click event
  ...
  //     // Clone the existing location element with a new data-id
  //     var newLocation = $('.open-table-main:first').clone();
  //     newLocation.find('[data-id]').attr('data-id', locationCount);

  //     // Clear the input values or set default values if needed
  //     newLocation.find('input[type="text"]').val('');
  //     newLocation.find('input[type="radio"]').prop('checked', false);
  //     newLocation.find('input[type="time"]').val('9:00am'); // Set default time values

  //     newLocation.find(".time_table1").attr("id", "time_table_" + locationCount);
  //           newLocation.find(".locup").attr("id", "locup" + locationCount);
  //           newLocation.find(".time_table1").attr("data-form-id", locationCount);
      
  //     // Append the new location element to the container
  //     $('.location-card').append(newLocation);
  //   });
  // });

  // $(document).ready(function() {
  //       // Counter to keep track of the number of location forms added
  //       var locationCounter = 0;

  //       // Function to clone and append a new location form
  //       function addLocationForm() {
  //           locationCounter++;

  //           var $newLocationForm = $(".open-table-main:first").clone();
  //           $newLocationForm.find("input[type=text]").val(""); // Clear input values
  //           $newLocationForm.find(".time_table1").attr("id", "time_table_" + locationCounter);
  //           $newLocationForm.find(".locup").attr("id", "locup" + locationCounter);
  //           $newLocationForm.find(".time_table1").attr("data-form-id", locationCounter);
  //           $newLocationForm.find(".insight-btn").remove(); // Remove the "Add Another Location" link from the cloned form

  //           $(".location-card").append($newLocationForm);
  //       }

  //       // Handle the click event on the "Add Another Location" button
  //       $("#addLocationBtn").on("click", function(e) {
  //           e.preventDefault();
  //           addLocationForm();
  //       });
  ...
  $(document).ready(function () {
    // Counter to track the number of locations
    let locationCounter = '{{ count($locations) }}';
    let totallocation = '{{ count($locations) }}';
    // Function to append the HTML structure
    function appendLocation() {
      ...
      <div class="open-table-main open-table-main-new last-remove">
      <span class="remove-img remove-icon "  ><img src="{{asset('admin_dashboard/assets/images/remove.png')}}" height="20px" alt="no img"></span>
                            <div class="open-table-inner">

                                <span class="edit-img table_time1" id="table_time1`+locationCounter+`" data-id="`+locationCounter+`"><img src="{{asset('admin_dashboard/assets/images/round-e.png')}}" alt="no img"></span>

                                <h2 class="opening-text"> <img src="{{asset('admin_dashboard/assets/images/Vector.png')}}" alt="no img"> Location ${locationCounter} <span id="empty`+locationCounter+`">(Empty)</span></h2>
                                

                                <div class="open-table-main pl-0 pr-0 open-table-main`+locationCounter+`" style="display:none;">
    						          <form class="time_table1" id="time_table_`+locationCounter+`"  data-form-id="`+locationCounter+`">
                                        <input type="text" id="locup`+locationCounter+`" name="locup" onkeypress="insert_location_option(this,`+locationCounter+`)" value="" class="form-control locup" style="display: none">
    						          	<button type="submit" class="btn btn-success time_submit1Btn" style="padding: 2px;
                                    font-size: 16px;
                                    width: 28px;
                                    height: 28px;
                                    ...
                                    display: block;
                                    float: right;
                                    margin-bottom: 15px;display:none;" 	hidden disabled id="time_submit`+locationCounter+`">
                                    &#10004;
    						    		</button>
    						            <div class="opening-table1">
    						              <!-- <form id="time_table1"> -->
    						              <table class="table t1 table-striped table_disable" id="t1`+locationCounter+`">
    						                <thead style="background: #F7FAFF;">
    						                  <tr class="disabled_table" id="auto`+locationCounter+`">
    						                    ...
    						                    <th scope="col">
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input  class="open_close" name="open_close" type="radio" value="open" data-id="`+locationCounter+`" disabled><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input class="open_close" type="radio" name="open_close" value="close" data-id="`+locationCounter+`" disabled><span>Closed</span>
    						                    ...
    						                    <th scope="col">
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="basicExampleho`+locationCounter+`" data-id="`+locationCounter+`" value="9:00am" disabled class="auto_time ui-timepicker-input from basicExampleho">
    						                      </span>
    						                    ...
    						                    <th scope="col">
    						                      ...
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="basicExamplehc`+locationCounter+`" data-id="`+locationCounter+`" value="5:00pm" disabled class="auto_time ui-timepicker-input basicExamplehc">
    						                      </span>
    						                ...
    						                <tbody id="tbody`+locationCounter+`">

    						                  <tr class="disabled_table" id="monday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked name="monday_open_close1" value="open" class="OpenClose" data-id="monday`+locationCounter+`" disabled><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" name="monday_open_close1"  value="close" class="OpenClose" data-id="monday`+locationCounter+`" disabled><span>Closed</span>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tmo" name="monday_open_time1"  value="9:00am" disabled required class="to ui-timepicker-input">
    						                      </span>
    						                    </td>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tmc" name="monday_close_time1" disabled  value="5:00pm" required class="tc ui-timepicker-input">
    						                  ...
    						                  <tr class="disabled_table" id="tuesday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked  name="tuesday_open_close1" disabled value="open" class="OpenClose" data-id="tuesday`+locationCounter+`"><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" name="tuesday_open_close1" disabled value="close" class="OpenClose" data-id="tuesday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tto" name="tuesday_open_time1" disabled  value="9:00am"  required class="to ui-timepicker-input">
    						                      </span>
    						                    </td>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="ttc" name="tuesday_close_time1" disabled value="5:00pm" required  class="tc ui-timepicker-input">
    						                      </span>
    						                  ...
    						                  <tr class="disabled_table" id="wednesday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked  name="wednesday_open_close1" disabled value="open" class="OpenClose" data-id="wednesday`+locationCounter+`"><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio"  value="close" disabled name="wednesday_open_close1" class="OpenClose" data-id="wednesday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="two" name="wednesday_open_time1" disabled value="9:00am" required class="to ui-timepicker-input">
    						                      </span>
    						                    </td>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="twc" name="wednesday_close_time1" disabled  value="5:00pm" required class="tc ui-timepicker-input">
    						                  ...
    						                  <tr class="disabled_table" id="thursday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked name="thursday_open_close1" disabled value="open" class="OpenClose" data-id="thursday`+locationCounter+`" ><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio"  name="thursday_open_close1" disabled value="close" class="OpenClose" data-id="thursday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      ...
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="ttho" name="thrusday_open_time1" disabled   value="9:00am"  required class="to ui-timepicker-input">
    						                    ...
    						                    <td>
    						                      ...
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tthc" name="thrusday_close_time1" disabled value="5:00pm" required class="tc ui-timepicker-input">
    						                  ...
    						                  <tr class="disabled_table" id="friday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked  name="friday_open_close1" disabled value="open" class="OpenClose" data-id="friday`+locationCounter+`"><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio"  name="friday_open_close1" disabled value="close" class="OpenClose" data-id="friday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      ...
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tfo" name="friday_open_time1"  disabled  value="9:00am" required class="to ui-timepicker-input">
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tfc" name="friday_close_time1" disabled  value="5:00pm" required class="tc ui-timepicker-input">
    						                  ...
    						                  <tr class="disabled_table" id="saturday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked  name="saturday_open_close1" disabled value="open" class="OpenClose" data-id="saturday`+locationCounter+`"><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio"  name="saturday_open_close1" disabled value="close" class="OpenClose" data-id="saturday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tsso" name="saturday_open_time1" disabled   value="9:00am"  required class="to ui-timepicker-input">
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tssc"  value="5:00pm" disabled name="saturday_close_time1" required class="tc ui-timepicker-input">
    						                  ...
    						                  <tr class="disabled_table" id="sunday`+locationCounter+`">
    						                    ...
    						                    <td>
    						                      ...
    						                      <div class="custom-radio open">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio" checked  name="sunday_open_close1" disabled value="open" class="OpenClose" data-id="sunday`+locationCounter+`"><span>Open</span>
    						                      ...
    						                      <div class="custom-radio closed">
    						                        ...
    						                        <label>
    						                          ...
    						                          <input type="radio"  value="close" name="sunday_open_close1" disabled class="OpenClose" data-id="sunday`+locationCounter+`"><span>Closed</span>
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tso"   value="9:00am"  disabled name="sunday_open_time1" required class="to ui-timepicker-input" >
    						                    ...
    						                    <td>
    						                      <span class="time-picker">
    						                        ...
    						                        <input id="tsc"   value="5:00pm"  disabled name="sunday_close_time1" required class="tc ui-timepicker-input">
    						                      </span>
    						              ...
    						              <input name="business_id" name="business_id" value="{{$business_details->id}}" type="hidden">
    						              <input name="id" name="id" value="0" type="hidden">
    						              <input type="hidden" name="field" value="time_table">
    						              <input type="hidden" name="table" value="business_details">
    						              <!-- <button type="submit" style="display:none"class="btn btn-primary" hidden disabled id="time_submit1">Update</button> -->
    						              <!-- </form> -->
      ...
      // Append the new location HTML to the container
      $('.location-card').append(newLocationHtml);

    } else {
        
        alert("You can add only  10 location.");
    }
    ...
    $(document).on('click','#addLocationBtn', function(e) {
      ...
      $(this).closest('.last-remove').removeClass("last-remove");
        appendLocation();
    ...
    $(document).on('click', '.remove-icon', function() {    
      ...
      if ($(this).parent('.last-remove').length > 0) {
        
        var secondLastHello = $(".open-table-main #addLocationBtn").eq(-2);
        secondLastHello.show();
        location.reload(true);
      }
        $(this).parent('.open-table-main').remove();
        totallocation--;
        var lastElement = $(".open-table-main-new:last");
        lastElement.addClass("last-remove");
    });

    $('.insight-btn-status').click(function () {
        ...
        $.ajax({
            ...
            success: function(result) {
             if (result.status == 1) {
              ...
              buttonElement.removeClass("insight-btn-status-active").addClass("insight-btn-status-deactive");
            } else {
              buttonElement.text("Activate");
              buttonElement.removeClass("insight-btn-status-deactive").addClass("insight-btn-status-active");
            }
            },
            error: function(xhr, resp, text) {
              console.log(xhr.responseText);
