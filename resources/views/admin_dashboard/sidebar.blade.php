...
@endphp
                <div class="admin-left" id="mySidenav">
                    ...
                    <ul class="navigation-main">
                        ...
                        <li>
                            <a href="{{route('admin.perks-portal')}}">
                        ...
                        <li>
                            <a href="{{route('admin.push_notification') }}">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu sub-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('admin.account') }}">Account/T&Cs</a>
                                <a class="dropdown-item" href="{{ route('admin.plan') }}">Edit Plans</a>
                              </div>
                        </li>
                    </ul>
