...
@section('content')
    ...
    <div class="busines1-main">
        ...
        <div class="switch-field">
            ...
            <a href="{{route('admin.business')}}" class="back-btn" style="width:100%"> <img src="{{asset('admin_dashboard/assets/images/back.png')}}" alt="img" style="width:auto"> Coffee Elite / Deals Portal</a>
        ...
        <div class="business-step1" id="profiles">
            ...
            <div class="row sm-hidden xs-hidden" >
                ...
                <div class="col-md-6 ">
                  <div class="account-type-main" style="display:flex;align-items:Center;gap:12px;border-radius:12px">
                  <img src="{{asset('business_dashboard/assets/images/limited.png')}}" alt="logo">
                      <div>
                        <h4 style="font-weight:bold;font-size:20px">Limited Time Perk</h3>
                        <div class="" style="background-color:#e8f6ff;border:2px solid #6db4d7;border-radius: 6px;padding:14px">
                        ...
                        <a class="btn btn-warning" href="{{route('admin.create_limited_time_perk')}}" style="margin-top:12px;font-size:16px;">Create Limited time Perk</a>
                      </div>
                ...
                <div class="col-md-6 ">
                  <div class="account-type-main" style="display:flex;align-items:Center;gap:12px;border-radius:12px;padding:21px 20px;">
                  <img src="{{asset('business_dashboard/assets/images/ongoing_perk.png')}}" alt="logo">
                  <div>
                    <h4 style="font-weight:bold">Ongoing Perk</h4>
                      <div class="" style="background-color:#e8f6ff;border:2px solid #6db4d7;border-radius: 6px;padding:14px">
                        <ul style="margin-left: 2px!important;padding-left: 1em!important;">
