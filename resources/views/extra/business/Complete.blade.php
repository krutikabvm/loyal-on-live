...
<div class="container justify-content-center" >
 <div class=" d-flex justify-content-end mt-3 p-auto">
...
<div class="col-lg-4 col-xs-9 col-md-6 col-sm-9 p-4">

<div class="ftrs justify-content-left" style="width: 60%;
   ">
...
<div class="row justify-content-center" style="margin:5px;">
  ...
  <div class="rfts row justify-content-center">
<p>Where should we send your Loyal IOM tag (s)?</p>
<form method="GET" action="{{route('business.c2.page')}}"
>
    &nbsp; <input type="radio" name="fav_language" value="Isle of Man"> Isle of Man<br>
    &nbsp; <input type="radio" name="fav_language" value="Foxdale, Isle of Man"> Foxdale, Isle of Man<br>
    &nbsp; 
   

  
       </div>
       <div class="sad row justify-content-center">
     <p>Send to another address:</p>
     
     <input type="text" id="subscribeNews" name="subscribe" icon="fa fa-location" placeholder=" Search other address" style="background: #FCFCFD;
...
height: 50px;
  border-radius: 5px;">
       ...
       <div class="boi row justify-content-center">
