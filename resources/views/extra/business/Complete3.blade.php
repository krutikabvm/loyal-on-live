...
<div class="row justify-content-center" style="margin:5px;">
  ...
  <form method="GET" action="{{route('business.submit')}}">
     ...
     height:fit-content;
       ">
     <div class="row">
        <div class="col-8 justify-content-left" style=" float: left; text-align: start;">
        
            <label>Basic - Monthly Billing</label>
            <p>You won't be billed until 30 days after you activate your Loyal IOM account. 
                You can cancel your plan at any time.</p>
          </div>
          <div class="col-4 justify-content-right" style=" float: left; text-align: start;">
         
            <label>FREE for 30 Days</label>
     ...
     <div class="row">
        <div class="col-8 justify-content-left" style=" float: left; text-align: start;">
            ...
            <label>Loyal IOM Tags (s)+ Loyal IOM Marketing Pack
                Shipped to:                             </label>
          ...
          height:fit-content;
            ...
            <div style=" float: inline-start; text-align: start;">
              
              <label>Total to PayNow</label>
            </div>
  ...
  <input class="form-check-input" type="radio" name="pay" id="paynow" value="payNow">
  <label class="form-check-label" for="paynow">$30</label>
</div>
...
height:fit-content;
  ...
  <div style="padding:5px; margin:5px;">
    ...
    <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="pay" id="paycash" value="paycash">
  <label class="form-check-label" for="paycash">Pay By Cash</label>
</div>
       ...
       <div class="row justify-content-center" style="margin-top: 30px;">
        ...
        border-radius: 6px;">Submit Application </button>
      </div>
