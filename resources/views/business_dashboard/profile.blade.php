        ...
        <div class="col-md-7">
            ...
            <div class="profile-bio-sec ">
                <form id="bio_form" class="general_form">
                    ...
                    <p class="business_name">{{$business->business_name}}</p>
                    <h2 id="">Bio</h2>
                    ...
                    <div id="bio_form_container" style="display:none" >
                        ...
                        <input type="text" required placeholder="Business Name" value="{{@$business->business_name}}" name="business_name" class="custom-input" autocomplete="off" autofill= "off">
            ...
            <div class="loyality-card" style="display:none">
            ...
            @foreach(@$loyalties as $key=>$loyalty)
                <div class="loyality-main" style="display:none">
                            ...
                            {{-- <div class="stamp-collect-text-main">
                                ...
                                <div class="stamp-dropright">
                                    <select name="stamps_per_day" data-id="{{@$loyalty['id']}}" class="stamps_per_day" id="stamps_per_day{{$key}}" data-stamp-id="{{$key}}">
                                        @for($i=1;$i<11;$i++) <option @if(@$loyalty['stamps_per_day']==$i) selected @endif value="{{$i}}">Collect {{$i}} stamps </option>
                                            @endfor
                                ...
                                <div class="stamp-pad">
                                    <form class="images-form1" data-id="{{$key}}" action="{{ route('upload-images') }}" method="post" enctype="multipart/form-data">
                                        <div class="logo-text-main">
                                            ...
                                            <!-- id="stamps_text{{$key}}" -->
                                            <span>Collect &nbsp;</span><span >@if(@$loyalty['number_stamps'] == 5000 ) Unlimited @else {{$loyalty['number_stamps']}} @endif </span> <span>&nbsp;stamps to Earn: </span><span id="stamp_description_text">{{ $loyalty['description'] == 'Other' ? $loyalty['other_description'] : $loyalty['description'] }}</span>

                                            <div class="edit-icon4">
                                                <img src="{{asset('business_dashboard')}}/assets/images/edit.svg" alt="noimg" style="border-top-right-radius: 8px;margin-right:0px;" onclick="alert('To update your loyalty cards scheme please e-mail contact@loyal-iom.com')">
                                            </div>
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (id == "bio_form") {
                    ...
                    $(".business_name").html($("[name=business_name]").val());
