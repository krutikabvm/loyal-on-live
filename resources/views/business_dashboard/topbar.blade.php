...
<div class="top-sidebar-main">
                        <div class="sidebar-left-main">
                            ...
                            src="/{{$o->image}}"
                            @else
                            src="{{asset('business_dashboard/assets/images/user-img.svg')}}"
                            @endif
                            alt="user-img"></span>
                            {{-- {{$o->business_name}} --}}
                            <span class="usser-name">@yield('title')</span>
                        </div>
                        <div class="sidebar-right-main">
                            <a href="{{route('end')}}" class="logout-btn"> <img src="{{asset('business_dashboard/assets/images/log-out1.svg')}}" alt="icon"> Logout</a>
                        </div>
                    </div>
                    <script>
