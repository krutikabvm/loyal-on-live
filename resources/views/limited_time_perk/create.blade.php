...
@section('content')
    ...
    <div class="busines1-main">
        ...
        <div class="business-step1" id="profiles">
            ...
            @endif
            <form action="{{ route('limited_time_perk.store') }}" method="POST" id="limited_perks_form">
                @csrf
                <div class="col-md-7 ">
                    ...
                    <div class="account-type-main" style="margin-top:25px">
                                ...
                                <div class="col-md-4" style="margin-top:6px">
                                    <div class="">
                                        ...
                                        <div style="display:flex;justify-content: space-between">
                                            ...
                                            <select id="week_days" name="week_days[]" class="form-control select2" multiple>
                            ...
                            <div class="dropdown-calendar-container">
                                ...
                                <input type="hidden" name="expiration_date" class="expiration_date">
                                <span id="selected-text">1 Day  <i class="fa arrow-down"></i></span>
                                ...
                                <!-- Calendar Input -->
                                <input type="text" id="date-range-picker" name="date_range" class="calendar" placeholder="Select custom date range">
                            </div>
