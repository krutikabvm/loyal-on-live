...
<section>
    ...
    <div class="container">
        ...
        <div id="" class=" current">
            ...
            <form action="{{ route('ads_banner.update', $banner->id) }}" method="POST" id="limited_perks_form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    <div class="col-md-6">
                        <ul class="noti-form">
                        ...
                        <div class="upload-container" id="file_btn">
                            <div class="upload-box">
                                <div class="upload-icon">
                                    <img src="{{url('/'.$banner->img)}}" alt="cover-img" class="file_btn">
                                </div>
                        ...
                        <div class="account-type-main ">
                            ...
                            <div style="margin-bottom:8px;">
                                <input type="text" name="advert_name" class="form-control" value="{{$banner->advert_name}}">
                            </div>
                            <div class="wrapper">
                                <label class="pb-4" style="margin-bottom:8px;    font-size: large;">Url</label>
                                    <input type="text" name="url" class="form-control" style="width:100%" value="{{$banner->url}}">
                            </div>
                        </div>
                ...
                <div class="prev-img">
                    ...
                    <div class="white-box">
                        <img class="not_img" src="{{url('/'.$banner->img)}}" alt="no img">
                    </div>
                </div>
