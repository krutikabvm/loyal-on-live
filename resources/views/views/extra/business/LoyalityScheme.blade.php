...
<script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
...
<div class="col-lg-7 col-xs-9 col-md-6 col-sm-9 p-4 m-3" style="width:max-content !important;">
<form method="POST" action="{{route('business.loyalty')}}">
  @csrf
<div class="" style="">
    <h4 style="margin:20px;">Loyalty Scheme</h4>
...
height:fit-content;
  ...
  <div class="col-7"> <p style="font-family: Poppins;
    font-style: normal;
    ...
    font-weight: normal;
    font-size: 14px;">
   How many stamp does a customer need to collect to earn a reward? 
   (a complete loyalty card)
   </p> 
  
</div>
 <div class="col-4">
    <div class="dropdown">
    <input type="number" name="number_stamps" min=2 max=15 class="form-control">
...
<div class="row" style="margin:5px;">
    ...
    <div class="col-7"> <p style="font-family: Poppins;
     ...
     <input type="text" name="description" class="form-control">
        <!-- <button class="dropbtn">1 free coffee</button>
        <div class="dropdown-content">
        <a href="#">8</a>
        <a href="#">9</a>
        <a href="#">10</a>
  ...
  height:fit-content;
      ">
  <h6>Loyality Scheme</h6>
 <div class="inner-box">
    
        <div class="row">
            <div class="col-sm-2" style="margin: 5px;"> <img src="/home/brownmunda/Desktop/AdminPanel/123.jpeg" style="border-radius:50%; width: 40px; height:40px; ">
          </div>
         <div class="col-sm-6" style="margin: 5px;">
         
         <input type="text" class="form-control" placeholder="loyal Card Name" name="name" style="box-shadow: inset 0 0 4px 0px rgb(0 0 0 / 15%);">
         <input type="date" class="form-control" placeholder="Expiry Date" name="offer_expiry" >
     ...
     <div class="bottom-box">
       ...
       <div class="" style="
        ...
        border-radius: 6px;
        "> 
        <label for="upload-photo">Upload Logo</label>


  <input type="file" name="photo"  id="upload-photo" style="opacity: 0;">

  <div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="img"  checked="checked"  id="up" value="">
  <label class="form-check-label" for="inlineRadio1"></label>
</div>

</div>
@if($businessDetail->img)
or
...
@if($businessDetail->img)
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="img" id="logo" value="{{$businessDetail->img}}">
  <label class="form-check-label" for="inlineRadio1">Use Logo Img</label>
</div>
@endif
     </div>
 </div>
    
 <input type="hidden" value="{{$businessDetail->id}}" name="business_id">

      
           </div>
           <div class="row justify-content-center" style="margin-top: 30px;">
    
            <button data='LS1.html'
            type="submit"
